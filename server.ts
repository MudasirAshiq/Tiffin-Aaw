...
async function startServer() {
  ...
  async function initDb() {
    try {
      ...
      // Fix any broken image URLs in existing menu items
      const brokenImageFixes: Record<string, string> = {
        'https://images.unsplash.com/photo-1626777552726-4a6b547b4de5': 'https://images.unsplash.com/photo-1596797038530-2c107229654b',
        'https://images.unsplash.com/photo-1545231027-63b3f162934c': 'https://images.unsplash.com/photo-1574484284002-952d92456975',
        'https://images.unsplash.com/photo-1626132646533-46b582048fd6': 'https://images.unsplash.com/photo-1567337710282-00832b415979',
        'https://images.unsplash.com/photo-1563379091339-03b21bc4a4f8': 'https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8',
      };
      for (const [oldBase, newBase] of Object.entries(brokenImageFixes)) {
        await query(`UPDATE menu_items SET image = REPLACE(image, $1, $2) WHERE image LIKE $3`, [oldBase, newBase, `${oldBase}%`]);
      }
